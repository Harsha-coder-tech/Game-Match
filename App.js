...
class App extends Component {
  ...
  onThumbnailClick = id => {
    ...
    if (imagesList[imageIndex].id === id) {
  ...
  render() {
    const {score, timeLimit, activeTab, imageIndex, isGameOver} = this.state
    const filterImages = imagesList.filter(imgs => imgs.category === activeTab)

    return (
      <div className="bg-container">
        <div className="match-game-navbar-container">
          <img
          ...
          <ul className="score-timer-container">
            <li>
              <p className="score-title">
                Score:<span className="score-and-timeleft"> {score}</span>
              </p>
            </li>
            <li className="timer-container">
              ...
              />
              <p className="score-and-timeleft">{timeLimit} sec</p>
            </li>
          </ul>
        </div>
        {isGameOver ? (
          <div className="game-match-container">
            <ul className="game-score-card-container">
              <img
          ...
          <div className="game-match-container">
            ...
            <ul className="thumbnail-title-container">
              {tabsList.map(tab => (
                <li key={tab.tabId}>
                  <button
                    type="button"
                    ...
                    onClick={() => this.setState({activeTab: tab.tabId})}
                  >
                    {tab.displayText}
                  </button>
                </li>
              ...
              {filterImages.map(img => (
                <li key={img.id}>
                  <button
                    ...
                    onClick={() => this.onThumbnailClick(img.id)}
                  >
                    <img
